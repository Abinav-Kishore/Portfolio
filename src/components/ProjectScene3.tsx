...
import { ArrowUpRight, Layers, Sliders, FileText, CheckCircle2, AlertCircle } from 'lucide-react';
...
export const ProjectScene3: React.FC<ProjectScene3Props> = ({ onOpenModal, setCursorMode }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-baseline justify-between border-b border-[#C8C4B9] pb-4 mb-12">
        <div className="flex items-baseline gap-4">
          ...
          <div className="flex flex-col">
            <span className="font-mono-tech text-[10px] sm:text-xs text-[#355CFF] tracking-widest uppercase font-bold flex items-center gap-2">
      ...
      <div
        ...
        onMouseEnter={() => setCursorMode('drag', isDragging ? 'ROTATING' : 'DRAG ROTATE')}
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none opacity-40">
          <svg className="w-full h-full">
            <defs>
              <pattern id="p3-grid" width="30" height="30" patternUnits="userSpaceOnUse">
                <path d="M 30 0 L 0 0 0 30" fill="none" stroke="#C8C4B9" strokeWidth="0.5" />
              </pattern>
            </defs>
          ...
          >
            ...
            >
              <div className="w-full h-full flex flex-col justify-between font-mono-tech text-[9px] text-[#66645F]">
                <div className="flex justify-between items-center text-[#111111]">
                  <span className="font-bold">STRATA 01 // QDRANT EMBEDDINGS & REDIS</span>
                  <span className="text-[#355CFF]">INDEXING</span>
                </div>
                <div className="grid grid-cols-4 gap-2 h-32 my-auto">
                  {Array.from({ length: 16 }).map((_, i) => (
                    <div key={i} className="border border-dashed border-[#C8C4B9] flex flex-col items-center justify-center text-[7px] text-[#111111]">
                      <span>VEC_{i + 1}</span>
                      <span className="text-[#355CFF] text-[6px]">1536-D</span>
                    </div>
                  ))}
                </div>
                <span className="text-[8px]">EMBEDDING DENSITY: 12,400 TOKENS / CONTRACT</span>
              </div>
            </div>
            ...
            >
              <div className="w-full h-full flex flex-col justify-between font-mono-tech text-[9px] text-[#355CFF]">
                <div className="flex justify-between items-center">
                  <span className="font-bold">STRATA 02 // FASTAPI SEGMENTATION PIPELINE</span>
                ...
                <div className="space-y-2 my-auto">
                  <div className="p-2 border border-[#355CFF]/40 bg-white/40 text-[#111111] text-[8px] flex justify-between">
                    ...
                    <span className="text-emerald-700 font-bold">[EXTRACTED]</span>
                  </div>
                  <div className="p-2 border border-[#355CFF]/40 bg-white/40 text-[#111111] text-[8px] flex justify-between">
                  ...
                  <div className="p-2 border border-[#355CFF]/40 bg-white/40 text-[#111111] text-[8px] flex justify-between">
                    ...
                    <span className="text-red-700 font-bold">[HIGH OBLIGATION]</span>
                  </div>
                </div>
                <span className="text-[#66645F] text-[8px]">SEGMENTATION ENGINE: AST HIERARCHICAL PARSER</span>
              </div>
            </div>
            ...
            >
              <div className="w-full h-full flex flex-col justify-between font-mono-tech text-[9px]">
                <div className="flex justify-between items-center text-[#111111]">
                  <span className="font-bold">STRATA 03 // GEMINI REASONING CORE</span>
                ...
                <div className="my-auto space-y-2 text-[#111111]">
                  <div className="p-2 border border-[#C8C4B9] bg-white/60">
                    <p className="font-bold text-[9px] text-[#355CFF]">REASONING SUMMARY</p>
                    <p className="text-[8px] leading-relaxed text-[#66645F] mt-1 font-editorial">
                      Surface hidden operational liabilities in clause 4.2. Unlimited consequential damage exposure detected.
                    </p>
                  </div>
                  <div className="flex items-center justify-between text-[8px] text-[#66645F] border-t border-[#C8C4B9] pt-1.5">
                    ...
                    <span className="text-[#355CFF] font-bold">LATENCY: 420MS</span>
                  </div>
                </div>
                <span className="text-[#66645F] text-[8px]">CONTEXT WINDOW: 1M TOKENS</span>
              </div>
            </div>
            ...
            >
              <div className="w-full h-full flex flex-col justify-between font-mono-tech text-[9px]">
                <div className="flex justify-between items-center text-white">
                  <span className="font-bold">STRATA 04 // EXECUTIVE AUDIT DOSSIER</span>
                  <span className="text-emerald-400 font-bold">SCORING 8.4/10</span>
                </div>
                <div className="my-auto space-y-3">
                  <div className="flex justify-between items-center border-b border-white/20 pb-1">
                    ...
                    <span className="text-emerald-400 font-bold">LOW (1.2%)</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-white/20 pb-1">
        ...
        <div className="absolute top-6 left-6 font-mono-tech text-[10px] sm:text-xs text-[#66645F] uppercase tracking-wider space-y-1 pointer-events-none">
          ...
          <div>EXTRACTION · CLASSIFICATION · SEGMENTATION · ANALYSIS · SCORING · INDEXING</div>
        </div>
        ...
        <div className="absolute bottom-6 left-6 right-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 font-mono-tech text-xs bg-[#EAE6DC]/90 backdrop-blur-sm p-4 border border-[#C8C4B9]">
          <div className="flex items-center gap-4 w-full sm:w-80">
            ...
            />
            <span className="font-bold text-[#111111] text-[11px] w-8">{explosion}%</span>
          </div>

          <div className="text-[10px] text-[#66645F] uppercase hidden md:block">
            DRAG TO ROTATE PIPELINE PERSPECTIVE [ROT: {Math.round(rotation.x)}°, {Math.round(rotation.y)}°]
          </div>
      ...
      <div className="mt-12 pt-8 border-t border-[#C8C4B9] flex flex-col lg:flex-row lg:items-center justify-between gap-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 font-mono-tech text-xs">
          <div>
            ...
            <span className="font-bold text-[#111111]">{project3Data.role}</span>
          </div>
          <div>
          ...
          <div>
            ...
            <span className="font-bold text-[#355CFF]">Python · FastAPI · Gemini · Qdrant</span>
          </div>
          <div>
            <span className="text-[#66645F] block text-[10px] uppercase">INFRA</span>

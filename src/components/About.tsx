...
export const About: React.FC<AboutProps> = ({ setCursorMode }) => {
  const [photoFilter, setPhotoFilter] = useState<"mono" | "blueprint" | "scan">(
    "mono",
  );
    ...
    >
      ...
      <div className="section-header-row flex flex-col sm:flex-row items-start sm:items-baseline justify-between border-b border-[#C8C4B9] pb-3 sm:pb-4 mb-10 sm:mb-16 gap-2 sm:gap-0">
        <div className="flex flex-wrap items-baseline gap-2 sm:gap-4">
          ...
          <span className="font-mono-tech text-[10px] sm:text-xs uppercase tracking-widest text-[#66645F]">
            MANIFESTO & BIOGRAPHY //{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="relative w-full h-[calc(100%-48px)] overflow-hidden border border-[#C8C4B9] bg-[#1a1a1a] flex items-center justify-center">
              ...
              <div className="relative z-10 text-center font-display text-white">
                <div className="text-7xl font-black tracking-tighter text-[#355CFF]">
                  AK
                </div>
          ...
          <div className="border border-[#C8C4B9] bg-[#EAE6DC] p-5 shadow-xs relative">
            ...
            <div className="space-y-3 font-mono-tech text-xs">
              {PORTFOLIO_DATA.achievements.map((ach, idx) => (
                <div
                  key={idx}
                  className="p-2.5 bg-white/60 border border-[#C8C4B9]"
                >
        ...
        <div className="lg:col-span-7 space-y-8 sm:space-y-10 lg:space-y-12">
          ...
          <div className="font-editorial text-base sm:text-lg lg:text-xl text-[#111111] leading-relaxed space-y-4 sm:space-y-6">
            <p className="font-medium text-[#111111]">
              {PORTFOLIO_DATA.about.intro}
            </p>
            <p className="text-[#66645F]">{PORTFOLIO_DATA.about.philosophy}</p>
          ...
          <div className="border-y border-[#C8C4B9] py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 font-mono-tech text-xs">
              <div className="p-3.5 border border-[#C8C4B9] bg-[#EAE6DC]">
                <div className="text-[10px] text-[#355CFF] font-bold uppercase mb-1">
                  PROGRAMMING LANGUAGES
                </div>
                <div className="text-[#111111] font-semibold">
                  {PORTFOLIO_DATA.skills.programmingLanguages.join(" · ")}
                </div>
              </div>
              ...
              <div className="p-3.5 border border-[#C8C4B9] bg-[#EAE6DC]">
                ...
                <div className="text-[#111111] font-semibold">
                  {PORTFOLIO_DATA.skills.dsa.join(" · ")}
                </div>
              </div>
              ...
              <div className="p-3.5 border border-[#C8C4B9] bg-[#EAE6DC]">
                ...
                <div className="text-[#111111] font-semibold">
                  {PORTFOLIO_DATA.skills.backend.join(" · ")}
                </div>
              </div>
              ...
              <div className="p-3.5 border border-[#C8C4B9] bg-[#EAE6DC]">
                ...
                <div className="text-[#111111] font-semibold">
                  {PORTFOLIO_DATA.skills.frontend.join(" · ")}
                </div>
              </div>
              ...
              <div className="p-3.5 border border-[#C8C4B9] bg-[#EAE6DC]">
                ...
                <div className="text-[#111111] font-semibold">
                  {PORTFOLIO_DATA.skills.machineLearningAI.join(" · ")}
                </div>
              </div>
              ...
              <div className="p-3.5 border border-[#C8C4B9] bg-[#EAE6DC]">
                ...
                <div className="text-[#111111] font-semibold">
                  {PORTFOLIO_DATA.skills.systemDesign.join(" · ")}
                </div>
              </div>
              ...
              <div className="p-3.5 border border-[#C8C4B9] bg-[#EAE6DC]">
                ...
                <div className="text-[#111111] font-semibold">
                  {PORTFOLIO_DATA.skills.tools.join(" · ")}
                </div>
              </div>
            </div>
          </div>
              ...
              {PORTFOLIO_DATA.experience.map((exp, idx) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-1 sm:gap-0">
                    ...
                    <span className="text-[#66645F] uppercase text-[10px] sm:text-[11px] font-semibold">
                      {exp.company}
                    </span>
                  </div>
                  <p className="font-editorial text-[13px] sm:text-sm text-[#444] leading-relaxed">
                    {exp.description}
                  </p>
                </div>
              ))}
          ...
          <div className="pt-2 border-t border-[#C8C4B9]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 font-mono-tech text-xs">
              {PORTFOLIO_DATA.certifications.map((cert, idx) => (
                <div
                  key={idx}
                  className="p-3 border border-[#C8C4B9] bg-[#EAE6DC]"
                >
                  <div className="text-[10px] text-[#355CFF] font-bold uppercase mb-0.5">
                    {cert.issuer}
                  </div>
